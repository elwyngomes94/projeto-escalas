...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 font-sans">
      {/* Sidebar */}
      <aside className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white transition-transform duration-300 transform no-print
          ...
          <div className="p-4 mt-auto border-t border-slate-800">
            <div className="flex items-center p-2 rounded-lg bg-slate-800/50">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-slate-500">Unidade Operacional</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-8 no-print">
